...
This is the historical plan for the original prototype. Its root module names, `data/` paths, and commands describe the pre-refactor layout. Use the [README](../README.md) and [architecture guide](architecture.md) for the current application.
